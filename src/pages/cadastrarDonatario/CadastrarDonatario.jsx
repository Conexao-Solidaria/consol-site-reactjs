    ...
    if (infoInput.value.length > 0) {
      const yourConfig = {
        headers: {
          Authorization:
            "Bearer " +
            "eyJhbGciOiJIUzM4NCJ9.eyJzdWIiOiJqb2FvQGV4YW1wbGUuY29tIiwiaWF0IjoxNzI4NDE4NTgxLCJleHAiOjE3MzIwMTg1ODF9.JpnQcoct6mjEBzVDhZ8wJTTES-R8031wzfUMfD-4_zSSiFYi3bYrwo3LuWXWxDcZ",
        },
      };

      try {
        const response = await api.get(
          `familias/filtro/por-nome?nome=${infoInput.value}`,
          yourConfig,
        );
